"""
Training script for final_score_rumus2 model
Usage: python postpaid/training/train_final_score_rumus2.py
"""
...
def train_final_score_rumus2_model(df: pd.DataFrame, model_dir: str) -> dict:
    """
    Train the final_score_rumus2 model and save it.
...
def main():
    ...
    # Train model
    summary = train_final_score_rumus2_model(df, model_dir)
